...
namespace Travelogue.Repository.Migrations
{
    ...
    [Migration("20250812004148_SystemSettingUnit")]
    partial class SystemSettingUnit
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Travelogue.Repository.Entities.SystemSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("14fd4275-5988-4d86-97ed-844f230a4927"),
                            CreatedTime = new DateTimeOffset(new DateTime(2025, 8, 12, 7, 41, 36, 217, DateTimeKind.Unspecified).AddTicks(9422), new TimeSpan(0, 7, 0, 0, 0)),
                            IsActive = true,
                            IsDeleted = false,
                            Key = 1,
                            LastUpdatedTime = new DateTimeOffset(new DateTime(2025, 8, 12, 7, 41, 36, 217, DateTimeKind.Unspecified).AddTicks(9519), new TimeSpan(0, 7, 0, 0, 0)),
                            Value = "10"
                        });
                });
