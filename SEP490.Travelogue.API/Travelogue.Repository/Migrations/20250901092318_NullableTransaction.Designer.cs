...
namespace Travelogue.Repository.Migrations
{
    ...
    [Migration("20250901092318_NullableTransaction")]
    partial class NullableTransaction
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Travelogue.Repository.Entities.CommissionRate", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("fee89a68-f93a-4dad-a04c-1833bba1c7c4"),
                            CreatedBy = "System",
                            CreatedTime = new DateTimeOffset(new DateTime(2025, 9, 1, 9, 23, 14, 464, DateTimeKind.Unspecified).AddTicks(4252), new TimeSpan(0, 0, 0, 0, 0)),
                            EffectiveDate = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsActive = true,
                            IsDeleted = false,
                            LastUpdatedBy = "System",
                            LastUpdatedTime = new DateTimeOffset(new DateTime(2025, 9, 1, 9, 23, 14, 464, DateTimeKind.Unspecified).AddTicks(4260), new TimeSpan(0, 0, 0, 0, 0)),
                            RateValue = 5m,
                            Type = 1
                        },
                        new
                        {
                            Id = new Guid("18bc7834-adf6-42c4-932e-1978ca74a1d5"),
                            CreatedBy = "System",
                            CreatedTime = new DateTimeOffset(new DateTime(2025, 9, 1, 9, 23, 14, 464, DateTimeKind.Unspecified).AddTicks(4268), new TimeSpan(0, 0, 0, 0, 0)),
                            EffectiveDate = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsActive = true,
                            IsDeleted = false,
                            LastUpdatedBy = "System",
                            LastUpdatedTime = new DateTimeOffset(new DateTime(2025, 9, 1, 9, 23, 14, 464, DateTimeKind.Unspecified).AddTicks(4270), new TimeSpan(0, 0, 0, 0, 0)),
                            RateValue = 3m,
                            Type = 2
                        });
                });
            ...
            modelBuilder.Entity("Travelogue.Repository.Entities.SystemSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("7ffdc624-9338-4510-9d16-fbb37856b177"),
                            CreatedTime = new DateTimeOffset(new DateTime(2025, 9, 1, 16, 23, 14, 464, DateTimeKind.Unspecified).AddTicks(3679), new TimeSpan(0, 7, 0, 0, 0)),
                            IsActive = true,
                            IsDeleted = false,
                            Key = 1,
                            LastUpdatedTime = new DateTimeOffset(new DateTime(2025, 9, 1, 16, 23, 14, 464, DateTimeKind.Unspecified).AddTicks(3769), new TimeSpan(0, 7, 0, 0, 0)),
                            Unit = "%",
                            Value = "10"
                        });
                });
