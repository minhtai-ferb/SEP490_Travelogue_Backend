...
namespace Travelogue.Repository.Migrations
{
    ...
    [Migration("20250831071152_Transactions")]
            ...
            modelBuilder.Entity("Travelogue.Repository.Entities.CommissionRate", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("fc9e85ee-0603-4037-9f35-d0e2cc0db804"),
                            CreatedBy = "System",
                            CreatedTime = new DateTimeOffset(new DateTime(2025, 8, 31, 7, 11, 48, 632, DateTimeKind.Unspecified).AddTicks(2249), new TimeSpan(0, 0, 0, 0, 0)),
                            EffectiveDate = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsActive = true,
                            IsDeleted = false,
                            LastUpdatedBy = "System",
                            LastUpdatedTime = new DateTimeOffset(new DateTime(2025, 8, 31, 7, 11, 48, 632, DateTimeKind.Unspecified).AddTicks(2258), new TimeSpan(0, 0, 0, 0, 0)),
                            RateValue = 5m,
                            Type = 1
                        },
                        new
                        {
                            Id = new Guid("db4f808d-6588-4d6f-abe2-5b8f9c4376c2"),
                            CreatedBy = "System",
                            CreatedTime = new DateTimeOffset(new DateTime(2025, 8, 31, 7, 11, 48, 632, DateTimeKind.Unspecified).AddTicks(2273), new TimeSpan(0, 0, 0, 0, 0)),
                            EffectiveDate = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsActive = true,
                            IsDeleted = false,
                            LastUpdatedBy = "System",
                            LastUpdatedTime = new DateTimeOffset(new DateTime(2025, 8, 31, 7, 11, 48, 632, DateTimeKind.Unspecified).AddTicks(2275), new TimeSpan(0, 0, 0, 0, 0)),
                            RateValue = 3m,
                            Type = 2
                        });
                });
            ...
            modelBuilder.Entity("Travelogue.Repository.Entities.SystemSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("39c8465b-083a-49d3-af37-bfd3eab3f3ef"),
                            CreatedTime = new DateTimeOffset(new DateTime(2025, 8, 31, 14, 11, 48, 632, DateTimeKind.Unspecified).AddTicks(1500), new TimeSpan(0, 7, 0, 0, 0)),
                            IsActive = true,
                            IsDeleted = false,
                            Key = 1,
                            LastUpdatedTime = new DateTimeOffset(new DateTime(2025, 8, 31, 14, 11, 48, 632, DateTimeKind.Unspecified).AddTicks(1565), new TimeSpan(0, 7, 0, 0, 0)),
                            Unit = "%",
                            Value = "10"
                        });
                });
