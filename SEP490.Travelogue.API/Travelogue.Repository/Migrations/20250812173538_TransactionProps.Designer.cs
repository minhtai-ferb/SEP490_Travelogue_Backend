...
namespace Travelogue.Repository.Migrations
{
    ...
    [Migration("20250812173538_TransactionProps")]
    partial class TransactionProps
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Travelogue.Repository.Entities.SystemSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("f95c8c6d-5a06-44e3-b822-ddf2da6b7dfe"),
                            CreatedTime = new DateTimeOffset(new DateTime(2025, 8, 13, 0, 35, 32, 128, DateTimeKind.Unspecified).AddTicks(5149), new TimeSpan(0, 7, 0, 0, 0)),
                            IsActive = true,
                            IsDeleted = false,
                            Key = 1,
                            LastUpdatedTime = new DateTimeOffset(new DateTime(2025, 8, 13, 0, 35, 32, 128, DateTimeKind.Unspecified).AddTicks(5267), new TimeSpan(0, 7, 0, 0, 0)),
                            Unit = "%",
                            Value = "10"
                        });
                });
