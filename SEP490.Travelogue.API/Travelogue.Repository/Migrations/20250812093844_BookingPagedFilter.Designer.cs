...
namespace Travelogue.Repository.Migrations
{
    ...
    [Migration("20250812093844_BookingPagedFilter")]
    partial class BookingPagedFilter
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Travelogue.Repository.Entities.SystemSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3f612688-d847-4af7-92ec-6ac8d953b7ad"),
                            CreatedTime = new DateTimeOffset(new DateTime(2025, 8, 12, 16, 38, 41, 868, DateTimeKind.Unspecified).AddTicks(3154), new TimeSpan(0, 7, 0, 0, 0)),
                            IsActive = true,
                            IsDeleted = false,
                            Key = 1,
                            LastUpdatedTime = new DateTimeOffset(new DateTime(2025, 8, 12, 16, 38, 41, 868, DateTimeKind.Unspecified).AddTicks(3844), new TimeSpan(0, 7, 0, 0, 0)),
                            Unit = "%",
                            Value = "10"
                        });
                });
