...
namespace Travelogue.Repository.Migrations
{
    ...
    [Migration("20250817194351_AddTourProps")]
    partial class AddTourProps
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Travelogue.Repository.Entities.SystemSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("399388f3-56cb-466c-ab7c-1f9c8575bbf2"),
                            CreatedTime = new DateTimeOffset(new DateTime(2025, 8, 18, 2, 43, 48, 592, DateTimeKind.Unspecified).AddTicks(3123), new TimeSpan(0, 7, 0, 0, 0)),
                            IsActive = true,
                            IsDeleted = false,
                            Key = 1,
                            LastUpdatedTime = new DateTimeOffset(new DateTime(2025, 8, 18, 2, 43, 48, 592, DateTimeKind.Unspecified).AddTicks(3179), new TimeSpan(0, 7, 0, 0, 0)),
                            Unit = "%",
                            Value = "10"
                        });
                });
