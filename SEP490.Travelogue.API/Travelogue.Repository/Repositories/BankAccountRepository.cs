...
{
    Task<PagedResult<BankAccount>> GetPageWithSearchAsync(int pageNumber, int pageSize, string name, CancellationToken cancellationToken = default);
    ...
    Task<PagedResult<BankAccount>> GetPageWithSearchAsync(
        string? title,
        int pageNumber,
        int pageSize,
...
public sealed class BankAccountRepository : GenericRepository<BankAccount>, IBankAccountRepository
{
    ...
    public async Task<PagedResult<BankAccount>> GetPageWithSearchAsync(int pageNumber, int pageSize, string name, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<PagedResult<BankAccount>> GetPageWithSearchAsync(
        string? title,
        int pageNumber,
        int pageSize,
        CancellationToken cancellationToken = default)
