...
{
    Task<PagedResult<Booking>> GetPageWithSearchAsync(int pageNumber, int pageSize, string name, CancellationToken cancellationToken = default);
    ...
    Task<PagedResult<Booking>> GetPageWithSearchAsync(
        string? title,
        int pageNumber,
        int pageSize,
...
public sealed class BookingRepository : GenericRepository<Booking>, IBookingRepository
{
    ...
    public async Task<PagedResult<Booking>> GetPageWithSearchAsync(int pageNumber, int pageSize, string name, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<PagedResult<Booking>> GetPageWithSearchAsync(
        string? title,
        int pageNumber,
        int pageSize,
        CancellationToken cancellationToken = default)
